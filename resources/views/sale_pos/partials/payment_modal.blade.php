                        ...
                        <div class="box box-solid bg-orange">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br/>
                                    <span class="lead text-bold total_payable_span">0</span> <b style="margin-left: 25px;
                                                                                                font-size: 20px;
                                                                                                color: #770606;">OR</b>
                                    <span class="lead text-bold total_payable_khr">0</span>
                                    <input type="hidden" id="total_payable_khr">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br/>
                                    <span class="lead text-bold total_paying">0</span><b style="margin-left: 25px;
                                                                                         font-size: 20px;
                                                                                         color: #770606;">ADD</b>
                                    <span class="lead text-bold total_paying_khr">0</span>
                                    <input type="hidden" id="total_paying_input">
                                    <input type="hidden" id="total_paying_input_khr">
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <b style="margin-left: 28px;
                                       font-size: 20px;
                                       color: #770606;">ADD</b>
                                     <span class="lead text-bold change_return_khr">0</span>  
